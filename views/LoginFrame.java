		...
		loginBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (AuthController.login(email.getText(), String.valueOf(passwordField.getPassword()))){
					...
					if (AuthController.getUserLogged() instanceof Manager) new SchoolYearsFrame();
					else if(AuthController.getUserLogged() instanceof DepartmentCoordinator) new MyDepartmentFrame();
					else if(AuthController.getUserLogged() instanceof CourseCoordinator) new MyCourseFrame();
