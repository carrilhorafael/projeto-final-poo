...
public class CreateCoordinatorPanel extends JFrame{

	FlowLayout mainLayout = new FlowLayout();
	/**
	 * Create the application.
	 */
	public CreateCoordinatorPanel(int typeCoordinator) {
		...
		createBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(created == null){
					...
					if(typeCoordinator == 2) new CreateDepartmentFrame();
					else if(typeCoordinator == 3) new CreateCourseFrame();
					frame.dispose();
				}else{
